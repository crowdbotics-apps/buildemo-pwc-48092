"""
Django settings for buildemo_pwc_48092 project.
...
ROOT_URLCONF = 'buildemo_pwc_48092.urls'
...
WSGI_APPLICATION = 'buildemo_pwc_48092.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "buildemo_pwc_48092 API",
    "DESCRIPTION": "API documentation for buildemo_pwc_48092 App",
    "VERSION": "v1",
}
